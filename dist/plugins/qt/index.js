...
`;
        const parsed = runPSJson(script, 5000);
        const cls = parsed.className;
        if (cls.startsWith('Qt6'))
            return { isQt: true, version: 6 };
        if (cls.startsWith('Qt5'))
            return { isQt: true, version: 5 };
        return { isQt: false };
    }
    catch {
        return { isQt: false };
